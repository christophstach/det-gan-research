...
class ResGanTrial(PyTorchTrial):
    def __init__(self, context: PyTorchTrialContext):
        ...
        self.generator = ResGenerator(self.g_depth, self.image_size, self.image_channels, self.latent_dim)
        self.generator = ExponentialMovingAverage(self.generator)
        self.discriminator = ResDiscriminator(self.d_depth, self.image_size, self.image_channels, self.score_dim)
        ...
        self.fid = self.context.wrap_reducer(
